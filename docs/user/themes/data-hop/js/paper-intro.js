var cs, paddingY;
var introContainer = document.getElementById('intro-animation-container');
...
var circleBgColor = yellow;
var sectionBgColor = light;
var dotsColor = dark;
...
function onFrame(event){
    if (!started) {
        started = true;
        document.querySelector('.intro__animation--main').classList.add('intro__animation--started');
    }
